...
ols = pd.read_pickle('Results/results_working_wls_FE_end_weights_alt')

fig, axes = plt.subplots(figsize = (10,12), nrows = 5)


def coef_plot(ax, array):
    ax.plot(list(range(-18, 25)), array[-45:-2], marker = 'o')
...
fig.savefig('Figures/figure_working_wls_FE_end_weights_alt.png')