...
spec_options = ['looking ~ C(birth_recode) : (C(tfipsst) + C(rhcalyr) + policy)',
                'looking ~ C(rhcalyr) + C(tfipsst) + C(birth_recode) : (C(tfipsst) + C(rhcalyr) + policy)',
                'looking ~ C(rhcalyr) : C(tfipsst) + C(birth_recode) : (C(tfipsst) + C(rhcalyr) + policy)',
                'looking ~ C(rhcalyr) * C(tfipsst) + C(birth_recode) : (C(tfipsst) + C(rhcalyr) + policy)',
                'looking ~ C(unique_id) + C(rhcalyr) : C(tfipsst) + C(birth_recode) : (C(tfipsst) + C(rhcalyr) + policy)']
...
ols_results.to_pickle('Results/results_looking_wls_FE_end_weights')