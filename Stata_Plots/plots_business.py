...
coef_plot(axes[0], ols['b_rm_lfp_X13'])
axes[0].set_title('Labor-force Participation')
coef_plot(axes[1], ols['b_working_X13'])
axes[1].set_title('Employment')
coef_plot(axes[2], ols['b_looking_X13'])
axes[2].set_title('Job Search')



fig.tight_layout(rect=[0, 0.03, 1, 0.95])
fig.suptitle('Business and Finance Difference in Difference Coefficients', fontsize = 16)
plt.show()
fig.savefig('Stata_Figures/figure_business.png')