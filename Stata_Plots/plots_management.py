...
ols = pd.read_stata('Stata_Results/results_management.dta')
...
fig.suptitle('Management Difference in Difference Coefficients', fontsize = 16)
plt.show()
fig.savefig('Stata_Figures/figure_management.png')