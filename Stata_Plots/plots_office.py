...
ols = pd.read_stata('Stata_Results/results_office.dta')
...
coef_plot(axes[0], ols['b_X1'])
axes[0].set_title('Labor-force Participation')
coef_plot(axes[1], ols['b_X2'])
...
fig.suptitle('Office and Administrative Support Difference in Difference Coefficients', fontsize = 16)
plt.show()
fig.savefig('Stata_Figures/figure_office.png')