...
headers = ['OCC_CODE', 'occ_title', 'TJBOCC1']
occ_codes = pd.read_excel('nem-occcode-acs-crosswalk.xlsx', names = headers)
...
occ_merged.sort_values('A_MEAN', ascending = False, inplace = True)
...
occ_merged['occ_rank'] = occ_merged['A_MEAN'].rank(ascending = False)

# Drop superfluous columns
occ_small = occ_merged[['TJBOCC1', 'occ_title', 'occ_rank']]
